...
InputHandler* InputHandler::s_pInstance = 0;//SINGLETON INSTANCE POINTER

//CONSTRUCTOR & DE-CONSTRUCTOR -  INSTANCE - POINTER - SINGLETON
...
//CLEAN ALL JOYSTICKS -  CLOSE THEM ALL
void InputHandler::clean()
{
    //WE NEED TO ALWAYS CLEAN UP AFTER OURSELVES AND CLOSE JOYSTICK
...
{
    //IF WE HAVE NOT ALREADY INITIALIZED JOYSTICKS, WE DO IT HERE
